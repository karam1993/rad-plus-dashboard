                      ...
                      <v-row no-gutters class="mt-2 mr-2">
                        <v-col cols="12">
                          <p class="mb-0"><span style="width: 15px;height: 15px;border-radius: 5px;display: inline-block;background: #222071;"></span>  
                            <span class="white--text" style="position: relative; top: -4px; left: -4px;" >{{ $t('cards.avilable') }}  <span class="mx-4">{{ cardInfo.bw_down_max ? 100 - Math.round(cardInfo.bw_down_used * 100 / cardInfo.bw_down_max * 100) / 100 + ' % ' : $t('common.unlimit') }} </span> 
                            </span>
                          </p>
                          <p class="mb-0"><span style="width: 15px;height: 15px;border-radius: 5px;display: inline-block;background: #f3e9da;"></span> 
                            <span class="white--text" style="position: relative; top: -4px; left: -4px;" >{{ $t('cards.used') }}   <span class="mx-2">{{ cardInfo.bw_down_max ? Math.round(cardInfo.bw_down_used * 100 / cardInfo.bw_down_max * 100) / 100 + ' % ' : $t('common.unlimit') }} </span> 
                            </span>
                          </p>
                          ...
                          <p class="mb-1 text-left white--text" style="font-size: 13px;"> 
                            <span class="text-center" style="width: 100px ; top: 2px; position: relative; border: 1px solid; height: 20px; display: inline-block;">{{ cardPassword }}</span> <v-btn icon small @click="getPasswordCard"><v-icon small class="" color="white">mdi-eye</v-icon></v-btn> 
                          </p> 
                        </v-col>
                      </v-row>
                    </v-col>
            ...
            <v-col cols="12" md="7" xl="9">
              <v-card>
                ...
                <v-card-text>
                  ...
                  <!-- <p class="mb-1"><b>{{ $t('cards.bw_down_max') }} :</b> <span>{{ convertSpeed(cardInfo.bw_down_max) }} </span></p>
                  <p class="mb-1"><b>{{ $t('cards.bw_up_max') }} :</b> <span>{{ convertSpeed(cardInfo.bw_up_max) }}</span></p> -->
...
export default {
  components :{
    MessageResetConfirm , MessageResetPasswordConfirm , AddNewPacketConfirm , MessageReNewConfirm ,MessageUpgradeConfirm
  }, 
  mixins: [Rules] ,
  data() {
    return {
    ...
    getCardInfo() {
      ...
      this.$axios
        ...
        .then((res) => {
          ...
          this.series = this.cardInfo.bw_down_max ?  [100 - Math.round(this.cardInfo.bw_down_used * 100 / this.cardInfo.bw_down_max * 100)  / 100] : [100]
