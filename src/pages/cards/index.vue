...
export default {
    ...
    return {
      ...
      cardFilter : {
        ...
        items : [
          ...
          { placeHolder : this.$t('cards.packet') , key: 'filter[packetid]' , value : '' , type : 'autocomplete' , items: [] , itemText : 'name' , itemId : 'packetid' } ,
          ...
          // dont change insexing this down object //
          ...
          // dont change insexing this up object //
        ]
      },
      cardPagination:{
        pagesCounts : 1 ,
  ...
  watch :{
    'cardFilter.items.4.searchKey': function (username) {
      if (username) {
  ...
  methods: {
    ...
    goToAttribute(item) {
      this.$router.push('/cards/' + item.id + '/attribute')
    }
  },
  head() {
    return {
