        ...
        <v-form ref="form" >
          <v-row>
            ...
            <v-col cols="12" md="6" class="pb-0 pt-1">
              ...
              > 
                <span v-if="userInfo.email_verified_at">{{ $t('user.email_verified') }} {{ userInfo.email_verified_at }}</span>
                <span v-else>{{ $t('user.email_not_verified') }}</span>
              </v-alert>
            </v-col>
            <v-col cols="12" md="6" class="pb-0 pt-1">
              <v-alert
              ...
              > 
                <span v-if="userInfo.mobile_verified_at">{{ $t('user.mobile_verified') }} {{ userInfo.mobile_verified_at }}</span>
                <span v-else>{{ $t('user.mobile_not_verified') }}</span>
              </v-alert>
            </v-col>
  ...
  methods: {
    ...
    save() {
      if (this.$refs.form.validate()) {
        ...
        this.$axios
          .$put(`/admin/user/${this.$route.params.id}`, this.userInfo)
          .then((res) => {
